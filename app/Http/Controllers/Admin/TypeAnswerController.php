...
class TypeAnswerController extends Controllers\Controller
{
    ...
    public function index()
    {
        ...
        $type_answers = TypeAnswer::orderBy('created_at', 'desc')->get(['id', 'name', 'url_image', 'confirm_answer']);
        $company = new Company;
        $companyData = getCompanyData();
        return view('admin.type_answers.index', compact('type_answers', 'companyData'));
    }
    ...
    public function create()
    {
        $company = new Company;
        $companyData = getCompanyData();
        return view('admin.type_answers.create', compact('companyData'));
    }
    ...
    public function edit($id)
    {
        ...
        $company = new Company;
        $companyData = getCompanyData();
        return view('admin.type_answers.edit', compact('type_answer', 'companyData'));
    }
