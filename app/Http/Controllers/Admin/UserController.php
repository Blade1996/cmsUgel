...
class UserController extends Controller
{
    ...
    public function store(UserPostRequest $request)
    {
        ...
        $userRecord = [
            [
                ...
                'addittional_info' => json_encode(['gender' => $request->gender, 'worker_type' => $request->worker_type, 'nameCity' => $request->name_city]),
    ...
    public function edit($id)
    {
        ...
        $user_info = json_decode($user->addittional_info);
        $user['gender'] = $user_info->gender;
        $user['worker_type'] = $user_info->worker_type;
        $user['name_city'] = $user_info->nameCity;
        $company = new Company;
        $companyData = getCompanyData();
        return view('admin.users.edit', compact('user', 'companyData'));
    }
    ...
    public function update(UserPostRequest $request, $id)
    {
        ...
        $user->addittional_info = json_encode(['gender' => $request->gender, 'worker_type' => $request->worker_type, 'nameCity' => $request->name_city]);
