                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 50%;">
                                                        <div style="text-align: right; padding-right: 17px;">
                                                            <img class="img-fluid"
                                                                src="https://laddigital.s3-sa-east-1.amazonaws.com/logo-enel.png">
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <table style="width: 100%;background-color: white;margin-top:21px" border-color:
                                            grey;>
                                            <tbody>
                                                <tr>
                                                    <td style="padding: 79px 80px 59px 80px">
                                                        <div>
                                                            <p
                                                                style="text-align: center; font-size: 18px; color: #5c5c5c;">
                                                                Ahora podrás seguir aprendiendo de <span
                                                                    style="font-weight: bold">la importancia de la
                                                                    equidad de género</span> sin excusas
                                                            </p>
                                                            <p style="color: #5c5c5c;text-align: center">
                                                                Haz clic en el botón y empieza con nuestro test
                                                            </p>
                                                            <p style="text-align: center;margin-bottom: 20px">
                                                                <a href="https://enel.netlify.app/sesion"
                                                                    target="_blank">
                                                                    <button
                                                                        style="background-color: #e73766;color: white;height: 45px;width: 182px;border: 1px solid #e73766;font-size: 19px;font-weight: bold;margin-top: 40px">
                                                                        INGRESAR
                                                                    </button>
                                                                </a>
                                                            </p>
