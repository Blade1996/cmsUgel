...
@section('title', 'Agregar Encargatura')
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('dashboard.charge.index') }}">Encargaturas</a>
                        </li>
                        <li class="breadcrumb-item active">Agregar Encargatura</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Agregar Encargatura</h3>
                        </div>
                        <!-- /.card-header -->
                        ...
                        <!-- form start -->
                        <form role="form" method="post" action="{{ route('dashboard.charge.create')}}" name="addSection"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Ingrese Nombre"
                                        id="chargeTitle" name="chargeTitle">
                                </div>
                                {{-- <div class="form-group">
