...
@section('title', 'Lista de Auxiliar')
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Auxiliar</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Tabla de Auxiliar</h3>
                            <a href="{{ route('dashboard.auxiliar.create') }}"
                                style="max-width: 150px; float: right; display:inline-block;"
                                class="btn btn-block btn-success">Agregar Auxiliar</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small class="badge badge-success update-status" style="cursor: pointer;"
                                                id="auxiliar-{{ $auxiliar->id }}" auxiliar_id="{{ $auxiliar->id }}"
                                                type="auxiliar">
                                                Activado
                                            </small>
                                            @else
