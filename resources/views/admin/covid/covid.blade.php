                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Tabla de Comunicados Covid</h3>
                            <a href="{{ route('dashboard.covid.create') }}"
                                style="max-width: 150px; float: right; display:inline-block;"
                                class="btn btn-block btn-success">Agregar Covid</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small class="badge badge-success update-status" style="cursor: pointer;"
                                                id="covid-{{ $covid->id }}" covid_id="{{ $covid->id }}" type="covid">
                                                Activado
                                            </small>
                                            @else
