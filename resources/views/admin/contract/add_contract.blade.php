            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('dashboard.contract.index') }}">Documentos</a>
                        </li>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- form start -->
                        <form role="form" method="post" action="{{ route('dashboard.contract.create')}}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Ingrese Nombre"
                                        id="contractTitle" name="contractTitle">
                                </div>
                                {{-- <div class="form-group">
