                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('dashboard.advertising.create') }}"
                                style="max-width: 150px; float: right; display:inline-block;"
                                class="btn btn-block btn-success">Agregar Publicidad</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="sectionsTable" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $advertising->titulo }}</td>
                                        <td>
                                            @if ($advertising->estado == 1)
                                            <small class="badge badge-success update-status" style="cursor: pointer;"
                                                id="advertising-{{ $advertising->id }}"
                                                advertising_id="{{ $advertising->id }}" type="advertising">
                                                Activado
                                            </small>
                                            @else
