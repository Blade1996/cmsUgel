...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Control</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <form role="form" method="post"
                            action="{{ route('dashboard.control.edit', $controlDetail['id'] )}}" name="updateDocument"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="currentCategoryId"
                                        value="{{ $controlDetail['category_id'] }}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Titulo Documento</label>
                                    <input type="text" class="form-control" placeholder="Ingrese Nombre"
                                        id="controlTitle" name="controlTitle" value="{{ $controlDetail['nombre'] }}">
                                </div>
                                {{-- <div class="form-group">
                                    <label for="exampleInputEmail1">Descripción</label>
                                    <textarea class="form-control" rows="3" name="controlDescription"
                                        id="controlDescription" placeholder="Ingrese Descripcion"
                                        style="margin-top: 0px; margin-bottom: 0px; height: 93px;">{!! $controlDetail['description'] !!}</textarea>
                                </div> --}}
                                <div class="form-group">
                                    <label for="exampleInputFile">Ingresar Archivo</label>
                                    <input type="file" class="form-control" name="controlFile" id="controlFile">
                                    <input type="hidden" name="currentControlFile" id="currentControlFile"
                                        value="{{ $controlDetail->archivo }}">
                                </div>
                            </div>
                            <!-- /.card-body -->
