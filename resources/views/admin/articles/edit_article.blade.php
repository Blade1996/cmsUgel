                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="iconClass" id="iconClass" class="form-control select2"
                                        style="width: 100%;">
                                        <option <?php if($articleDetail->icon_class=='fa-address-book' ) echo
                                            'selected="selected"' ;
                                            ?>
                                        ...
                                        <option <?php if($articleDetail->icon_class=='fa-address-card' ) echo
                                            'selected="selected"' ;
                                            ?>
                                        ...
                                        <option <?php if($articleDetail->icon_class=='fa-adjust' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-adjust'>&#xf042; fa-adjust </option>
                                        <option <?php if($articleDetail->icon_class=='fa-adn' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-adn'>&#xf170; fa-and </option>
                                        <option <?php if($articleDetail->icon_class=='fa-align-center' ) echo
                                            'selected="selected"' ;
                                            ?>
                                            value='fa-align-center'>&#xf037; fa-align-center </option>
                                        <option <?php if($articleDetail->icon_class=='fa-align-justify' ) echo
                                            'selected="selected"' ;
                                            ?>
                                            value='fa-align-justify'>&#xf039; fa-align-justify </option>
                                        <option <?php if($articleDetail->icon_class=='fa-align-left' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-align-left'>&#xf036; fa-align-left </option>
                                        <option <?php if($articleDetail->icon_class=='fa-align-right' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-align-right'>&#xf038; fa-align-right </option>
                                        <option <?php if($articleDetail->icon_class=='fa-amazon' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-amazon'>&#xf270; fa-amazon </option>
                                        <option <?php if($articleDetail->icon_class=='fa-toggle-down' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-toggle-down'>&#xf150; fa-toggle-down </option>
                                        <option <?php if($articleDetail->icon_class=='fa-toggle-left' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-toggle-left'>&#xf191; fa-toggle-left </option>
                                        <option <?php if($articleDetail->icon_class=='fa-toggle-off' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-toggle-off'>&#xf204; fa-toggle-off </option>
                                        <option <?php if($articleDetail->icon_class=='fa-toggle-on' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-toggle-on'>&#xf205; fa-toggle-on </option>
                                        <option <?php if($articleDetail->icon_class=='fa-toggle-right' ) echo
                                            'selected="selected"' ;
                                            ?>
                                            value='fa-toggle-right'>&#xf152; fa-toggle-right </option>
                                        <option <?php if($articleDetail->icon_class=='fa-toggle-up' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-toggle-up'>&#xf151; fa-toggle-up </option>
                                        <option <?php if($articleDetail->icon_class=='fa-trademark' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-trademark'>&#xf25c; fa-trademark </option>
                                        <option <?php if($articleDetail->icon_class=='fa-train' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-train'>&#xf238; fa-train </option>
                                        <option <?php if($articleDetail->icon_class=='fa-transgender' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-transgender'>&#xf224; fa-transgender </option>
                                        <option <?php if($articleDetail->icon_class=='fa-transgender-alt' ) echo
                                            'selected="selected"'
                                            ; ?>
                                            value='fa-transgender-alt'>&#xf225; fa-transgender-alt </option>
                                        <option <?php if($articleDetail->icon_class=='fa-trash' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-trash'>&#xf1f8; fa-trash </option>
                                        <option <?php if($articleDetail->icon_class=='fa-trash-o' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-trash-o'>&#xf014; fa-trash-o </option>
                                        <option <?php if($articleDetail->icon_class=='fa-tree' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-tree'>&#xf1bb; fa-tree </option>
                                        <option <?php if($articleDetail->icon_class=='fa-trello' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-trello'>&#xf181; fa-trello </option>
                                        <option <?php if($articleDetail->icon_class=='fa-tripadvisor' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-tripadvisor'>&#xf262; fa-tripadvisor </option>
                                        <option <?php if($articleDetail->icon_class=='fa-trophy' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-trophy'>&#xf091; fa-trophy </option>
                                        <option <?php if($articleDetail->icon_class=='fa-truck' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-truck'>&#xf0d1; fa-truck </option>
                                        <option <?php if($articleDetail->icon_class=='fa-try' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-try'>&#xf195; fa-try </option>
                                        <option <?php if($articleDetail->icon_class=='fa-tty' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-tty'>&#xf1e4; fa-tty </option>
                                        <option <?php if($articleDetail->icon_class=='fa-tumblr' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-tumblr'>&#xf173; fa-tumblr </option>
                                        <option <?php if($articleDetail->icon_class=='fa-tumblr-square' ) echo
                                            'selected="selected"' ;
                                            ?>
                                            value='fa-tumblr-square'>&#xf174; fa-tumblr-square </option>
                                        <option <?php if($articleDetail->icon_class=='fa-turkish-lira' ) echo
                                            'selected="selected"' ;
                                            ?>
                                            value='fa-turkish-lira'>&#xf195; fa-turkish-lira </option>
                                        <option <?php if($articleDetail->icon_class=='fa-tv' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-tv'>&#xf26c; fa-tv </option>
                                        <option <?php if($articleDetail->icon_class=='fa-twitch' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-twitch'>&#xf1e8; fa-twitch </option>
                                        <option <?php if($articleDetail->icon_class=='fa-twitter' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-twitter'>&#xf099; fa-twitter </option>
                                        <option <?php if($articleDetail->icon_class=='fa-twitter-square' ) echo
                                            'selected="selected"' ;
                                            ?>
                                            value='fa-twitter-square'>&#xf081; fa-twitter-square </option>
                                        <option <?php if($articleDetail->icon_class=='fa-umbrella' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-umbrella'>&#xf0e9; fa-umbrella </option>
                                        <option <?php if($articleDetail->icon_class=='fa-underline' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-underline'>&#xf0cd; fa-underline </option>
                                        <option <?php if($articleDetail->icon_class=='fa-undo' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-undo'>&#xf0e2; fa-undo </option>
                                        <option <?php if($articleDetail->icon_class=='fa-universal-access' ) echo
                                            'selected="selected"'
                                            ; ?>
                                            value='fa-universal-access'>&#xf29a; fa-universal-access </option>
                                        <option <?php if($articleDetail->icon_class=='fa-university' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-university'>&#xf19c; fa-university </option>
                                        <option <?php if($articleDetail->icon_class=='fa-unlink' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-unlink'>&#xf127; fa-unlink </option>
                                        <option <?php if($articleDetail->icon_class=='fa-unlock' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-unlock'>&#xf09c; fa-unlock </option>
                                        <option <?php if($articleDetail->icon_class=='fa-unlock-alt' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-unlock-alt'>&#xf13e; fa-unlock-alt </option>
                                        <option <?php if($articleDetail->icon_class=='fa-unsorted' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-unsorted'>&#xf0dc; fa-unsorted </option>
                                        <option <?php if($articleDetail->icon_class=='fa-upload' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-upload'>&#xf093; fa-upload </option>
                                        <option <?php if($articleDetail->icon_class=='fa-usb' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-usb'>&#xf287; fa-usb </option>
                                        <option <?php if($articleDetail->icon_class=='fa-usd' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-usd'>&#xf155; fa-usd </option>
                                        <option <?php if($articleDetail->icon_class=='fa-user' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-user'>&#xf007; fa-user </option>
                                        <option <?php if($articleDetail->icon_class=='fa-user-circle' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-user-circle'>&#xf2bd; fa-user-circle </option>
                                        <option <?php if($articleDetail->icon_class=='fa-user-circle' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-user-circle-o'>&#xf2be; fa-user-circle-o </option>
                                        <option <?php if($articleDetail->icon_class=='fa-user-md' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-user-md'>&#xf0f0; fa-user-md </option>
                                        <option <?php if($articleDetail->icon_class=='fa-user-o' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-user-o'>&#xf2c0; fa-user-o </option>
                                        <option <?php if($articleDetail->icon_class=='fa-user-plus' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-user-plus'>&#xf234; fa-user-plus </option>
                                        <option <?php if($articleDetail->icon_class=='fa-user-secret' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-user-secret'>&#xf21b; fa-user-secret </option>
                                        <option <?php if($articleDetail->icon_class=='fa-user-times' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-user-times'>&#xf235; fa-user-times </option>
                                        <option <?php if($articleDetail->icon_class=='fa-users' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-users'>&#xf0c0; fa-users </option>
                                        <option <?php if($articleDetail->icon_class=='fa-vcard' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-vcard'>&#xf2bb; fa-vcard </option>
                                        <option <?php if($articleDetail->icon_class=='fa-vcard-o' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-vcard-o'>&#xf2bc; fa-vcard-o </option>
                                        <option <?php if($articleDetail->icon_class=='fa-venus' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-venus'>&#xf221; fa-venus </option>
                                        <option <?php if($articleDetail->icon_class=='fa-venus-double' ) echo
                                            'selected="selected"' ;
                                            ?>
                                            value='fa-venus-double'>&#xf226; fa-venus-double </option>
                                        <option <?php if($articleDetail->icon_class=='fa-venus-mars' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-venus-mars'>&#xf228; fa-venus-mars </option>
                                        <option <?php if($articleDetail->icon_class=='fa-viacoin' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-viacoin'>&#xf237; fa-viacoin </option>
                                        <option <?php if($articleDetail->icon_class=='fa-viadeo' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-viadeo'>&#xf2a9; fa-viadeo </option>
                                        <option <?php if($articleDetail->icon_class=='fa-viadeo-square' ) echo
                                            'selected="selected"' ;
                                            ?>
                                            value='fa-viadeo-square'>&#xf2aa; fa-viadeo-square </option>
                                        <option <?php if($articleDetail->icon_class=='fa-video-camera' ) echo
                                            'selected="selected"' ;
                                            ?>
                                            value='fa-video-camera'>&#xf03d; fa-video-camera </option>
                                        <option <?php if($articleDetail->icon_class=='fa-vimeo' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-vimeo'>&#xf27d; fa-vimeo </option>
                                        <option <?php if($articleDetail->icon_class=='fa-vimeo-square' ) echo
                                            'selected="selected"' ;
                                            ?>
                                            value='fa-vimeo-square'>&#xf194; fa-vimeo-square </option>
                                        <option <?php if($articleDetail->icon_class=='fa-vine' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-vine'>&#xf1ca; fa-vine </option>
                                        <option <?php if($articleDetail->icon_class=='fa-vk' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-vk'>&#xf189; fa-vk </option>
                                        <option <?php if($articleDetail->icon_class=='fa-volume-control' ) echo
                                            'selected="selected"' ;
                                            ?>
                                            value='fa-volume-control-phone'>&#xf2a0; fa-volume-control-phone
                                        </option>
                                        <option <?php if($articleDetail->icon_class=='fa-volume-down' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-volume-down'>&#xf027; fa-volume-down </option>
                                        <option <?php if($articleDetail->icon_class=='fa-volume-off' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-volume-off'>&#xf026; fa-volume-off </option>
                                        <option <?php if($articleDetail->icon_class=='fa-volume-up' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-volume-up'>&#xf028; fa-volume-up </option>
                                        <option <?php if($articleDetail->icon_class=='fa-warning' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-warning'>&#xf071; fa-warning </option>
                                        <option <?php if($articleDetail->icon_class=='fa-wechat' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-wechat'>&#xf1d7; fa-wechat </option>
                                        <option <?php if($articleDetail->icon_class=='fa-weibo' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-weibo'>&#xf18a; fa-weibo </option>
                                        <option <?php if($articleDetail->icon_class=='fa-weixin' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-weixin'>&#xf1d7; fa-weixin </option>
                                        <option <?php if($articleDetail->icon_class=='fa-whatsapp' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-whatsapp'>&#xf232; fa-whatsapp </option>
                                        <option <?php if($articleDetail->icon_class=='fa-wheelchair' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-wheelchair'>&#xf193; fa-wheelchair </option>
                                        <option <?php if($articleDetail->icon_class=='fa-wheelchair-alt' ) echo
                                            'selected="selected"' ;
                                            ?>
                                            value='fa-wheelchair-alt'>&#xf29b; fa-wheelchair-alt </option>
                                        <option <?php if($articleDetail->icon_class=='fa-wifi' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-wifi'>&#xf1eb; fa-wifi </option>
                                        <option <?php if($articleDetail->icon_class=='fa-wikipedia-w' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-wikipedia-w'>&#xf266; fa-wikipedia-w </option>
                                        <option <?php if($articleDetail->icon_class=='fa-window-close' ) echo
                                            'selected="selected"' ;
                                            ?>
                                        ...
                                        <option <?php if($articleDetail->icon_class=='fa-window-maximize' ) echo
                                            'selected="selected"'
                                            ; ?>
                                            value='fa-window-maximize'>&#xf2d0; fa-window-maximize </option>
                                        <option <?php if($articleDetail->icon_class=='fa-window-minimize' ) echo
                                            'selected="selected"'
                                            ; ?>
                                            value='fa-window-minimize'>&#xf2d1; fa-window-minimize </option>
                                        <option <?php if($articleDetail->icon_class=='fa-window-restore' ) echo
                                            'selected="selected"' ;
                                            ?>
                                            value='fa-window-restore'>&#xf2d2; fa-window-restore </option>
                                        <option <?php if($articleDetail->icon_class=='fa-windows' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-windows'>&#xf17a; fa-windows </option>
                                        <option <?php if($articleDetail->icon_class=='fa-won' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-won'>&#xf159; fa-won </option>
                                        <option <?php if($articleDetail->icon_class=='fa-wordpress' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-wordpress'>&#xf19a; fa-wordpress </option>
                                        <option <?php if($articleDetail->icon_class=='fa-wpbeginner' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-wpbeginner'>&#xf297; fa-wpbeginner </option>
                                        <option <?php if($articleDetail->icon_class=='fa-wpexplorer' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-wpexplorer'>&#xf2de; fa-wpexplorer </option>
                                        <option <?php if($articleDetail->icon_class=='fa-wpforms' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-wpforms'>&#xf298; fa-wpforms </option>
                                        <option <?php if($articleDetail->icon_class=='fa-wrench' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-wrench'>&#xf0ad; fa-wrench </option>
                                        <option <?php if($articleDetail->icon_class=='fa-xing' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-xing'>&#xf168; fa-xing </option>
                                        <option <?php if($articleDetail->icon_class=='fa-xing-square' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-xing-square'>&#xf169; fa-xing-square </option>
                                        <option <?php if($articleDetail->icon_class=='fa-y-combinator' ) echo
                                            'selected="selected"' ;
                                            ?>
                                        ...
                                        <option <?php if($articleDetail->icon_class=='fa-yahoo' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-yahoo'>&#xf19e; fa-yahoo </option>
                                        <option <?php if($articleDetail->icon_class=='fa-yc' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-yc'>&#xf23b; fa-yc </option>
                                        <option <?php if($articleDetail->icon_class=='fa-yc-square' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-yc-square'>&#xf1d4; fa-yc-square </option>
                                        <option <?php if($articleDetail->icon_class=='fa-yelp' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-yelp'>&#xf1e9; fa-yelp </option>
                                        <option <?php if($articleDetail->icon_class=='fa-yen' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-yen'>&#xf157; fa-yen </option>
                                        <option <?php if($articleDetail->icon_class=='fa-yoast' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-yoast'>&#xf2b1; fa-yoast </option>
                                        <option <?php if($articleDetail->icon_class=='fa-youtube' ) echo
                                            'selected="selected"' ; ?>
                                            value='fa-youtube'>&#xf167; fa-youtube </option>
                                        <option <?php if($articleDetail->icon_class=='fa-youtube-play' ) echo
                                            'selected="selected"' ;
                                            ?>
                                            value='fa-youtube-play'>&#xf16a; fa-youtube-play </option>
                                        <option <?php if($articleDetail->icon_class=='fa-youtube-square' ) echo
                                            'selected="selected"' ;
                                            ?>
                                            value='fa-youtube-square'>&#xf166; fa-youtube-square </option>
                                    </select>
                                    <input type="hidden" class="form-control" id="currentIconClass"
                                        name="currentIconClass" value="{{$articleDetail->icon_class}}">
                                </div>
                                <div class="form-group">
