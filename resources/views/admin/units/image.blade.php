...
<div id="box-image" class="text-center">
    <div class="box8">
        <img class="img-fluid" id="show_img" src="@if(isset($unit->url_image)){{asset($unit->url_image)}}@endif"
            height="300">
...
@else
<img class="img-fluid" id="show_img" src="@if(isset($unit->url_image)){{asset($unit->url_image)}}@endif" height="300">
@endif
