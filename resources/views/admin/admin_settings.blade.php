            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- form start -->
                        <form role="form" method="post" action="{{ route('dashboard.update-pwd')}}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" value="{{ $adminDetails->email }}" class="form-control"
                                        readonly="">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Contraseña Actual</label>
                                    <input type="password" class="form-control" id="currentPassword"
                                        name="currentPassword" placeholder="Contraseña Actual" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="confirmPassword"
                                        name="confirmPassword" placeholder="Confirmar Nueva Contraseña" required>
                                </div>
                                {{-- <div class="form-group">
