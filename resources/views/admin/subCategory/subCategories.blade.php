                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Tabla de Sub Menus</h3>
                            <a href="{{ route('dashboard.subcategories.create') }}"
                                style="max-width: 150px; float: right; display:inline-block;"
                                class="btn btn-block btn-success">Agregar Sub Menu</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a data-toggle="tooltip"
                                                href="{{ route('dashboard.subcategories.edit', $subCategory->id) }}"
                                                data-toggle="tooltip" title="Editar" title="Editar">
                                                <i class="far fa-edit"></i>
                                            </a>
                                            <a href="javascript:void(0)" class="confirmDelete" style="cursor: pointer;"
                                                record="sub-categories" recordId="{{ $subCategory->id }}" data-toggle="tooltip"
                                                title="Eliminar">
