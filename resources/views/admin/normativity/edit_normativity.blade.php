                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <form role="form" method="post"
                            action="{{ route('dashboard.normativity.edit', $normativityDetail->id )}}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Ingrese Nombre"
                                        ...
                                        value="{{ $normativityDetail->nombre }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" name="normativityDescription"
                                        ...
                                        style="margin-top: 0px; margin-bottom: 0px; height: 93px;">{{ $normativityDetail->descripcion }}</textarea>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="currentNormativityFile" id="currentNormativityFile"
                                        value="{{ $normativityDetail->archivo }}">
                                </div>
                            </div>
                            <!-- /.card-body -->
