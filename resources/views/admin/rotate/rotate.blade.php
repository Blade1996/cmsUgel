                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('dashboard.rotate.create') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small class="badge badge-success update-status" style="cursor: pointer;"
                                                id="rotate-{{ $rotate->id }}" rotate_id="{{ $rotate->id }}"
                                                type="rotate">
                                                Activado
                                            </small>
                                            @else
