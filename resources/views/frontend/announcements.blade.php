                    ...
                    <table id="announcenentsTable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th colspan="10">Conjunto de Documentos</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                @foreach ($announcement->getMedia($mediaCollection) as $media)
                                <td><a href="{{ $media->getUrl() }}" tooltrip data-toggle="tooltip"
                                        title="{{ $media->name }}" target="_blank"><i class="far fa-file-pdf"></i></a>
                                </td>
                                @endforeach
                            </tr>
                            @endforeach
